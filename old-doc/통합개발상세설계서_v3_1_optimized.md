# 통합 경정청구 환급액 산출 시스템 — 개발상세설계서 v3.1

> **문서 버전**: v3.1 (v3.0 → 오류수정 + 최적화 반영)  
> **작성일**: 2026-02-16  
> **기준 프롬프트**:  
...
| **P2** | M1-03 (요약 생성) | V-RD-01, V-RD-02, B-SME-01, V-LOSS-01, V-EMP-01, B13 | P1 통과 필수 | TX-1 ROLLBACK — INP_* 생성 중단 |
