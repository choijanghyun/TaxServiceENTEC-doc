...
> 이력 상세는 [변경이력_v1.0_to_v4.0.md](변경이력_v1.0_to_v4.0.md) §1 참조.



### 11.5 v4.0r1 외부검토 반영 커버리지 확인

> 이력 상세는 [변경이력_v1.0_to_v4.0.md](변경이력_v1.0_to_v4.0.md) §2 참조.



---

# PART XI. 종합소득세 시스템 (TAX_TYPE='INC') — 신규 + v1.1 보완
...
> 이력 상세는 [변경이력_v1.0_to_v4.0.md](변경이력_v1.0_to_v4.0.md) §3 참조.


---

> 이력 상세는 [변경이력_v1.0_to_v4.0.md](변경이력_v1.0_to_v4.0.md) §4 참조.
...
## 부록 A: v1.1 오류지적사항 검토 결과

> 이력 상세는 [변경이력_v1.0_to_v4.0.md](변경이력_v1.0_to_v4.0.md) §5 참조.

> 이력 상세는 [변경이력_v1.0_to_v4.0.md](변경이력_v1.0_to_v4.0.md) §6 참조.
...
**[문서 끝]** — 통합 경정청구 환급액 산출 시스템 개발상세설계서 v4.0 (정리본)

> **본 문서는 자기완결적(Self-contained) 최종본**으로, 별도 참조 문서 없이 이 문서만으로 전체 시스템 설계를 파악할 수 있습니다.
> 변경이력·검토 결과는 [변경이력_v1.0_to_v4.0.md](변경이력_v1.0_to_v4.0.md)에 별도 수록.
